...
export function generateShareMessage(reward: {
  type: string
  rarity: string
  amount?: number
  name?: string
  ...
  return `I just cracked my Lucky Cube on Base and got a ${reward.rarity.toUpperCase()} reward: ${rewardText}! 🎲\n\nDay ${streak} streak. See you tomorrow 👀\n\nPlay at luckycube.app`
}
